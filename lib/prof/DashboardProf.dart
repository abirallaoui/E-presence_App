...
import 'package:pfa/prof/CodeQR.dart';
...
// Fonction pour effacer les données de session de l'utilisateur
      ...
      sideBar: SideBar(
        ...
        header: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const CircleAvatar(
                backgroundImage: AssetImage('prof.png'),
                radius: 50,
              ),
        ...
        footer: Container(
          ...
          child: SideBar(
            ...
            selectedRoute:'/',
            onSelected: (item) {
              if (item!.route != null && item.route == '/login') {
